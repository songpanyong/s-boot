...
/**   
 * @Description: 返佣收益转账监听
 * @author ZJ   
 * @date 2018年1月17日 上午11:45:02 
 * @version V1.0   
 */
@Component
@Slf4j
public class RebateTransferListener {
	/**
	 * 转账
	 * @param req
	 * @throws Exception
	 */
	@EventListener(condition = "#event.transType =='60' && #event.eventType == '03'")
	public void transfer(AccountTransferEvent event) throws Exception {
		log.info("返佣收益转账请求参数：accountTransferEvent = {}", event);
