...
/**   
 * @Description: 体验金收益转账监听 
 * @author ZJ   
 * @date 2018年1月17日 上午11:33:52 
 * @version V1.0   
 */
@Component
@Slf4j
public class ExperienceGoldTransferListener {
	/**
	 * 转账
	 * @param req
	 * @throws Exception
	 */
	@EventListener(condition = "#event.transType =='05' && #event.eventType == '03'")
