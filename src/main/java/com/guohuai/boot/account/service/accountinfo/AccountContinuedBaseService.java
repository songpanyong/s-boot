...
import com.guohuai.boot.account.service.InvestorContinuedService;
...
/**   
 * @Description: 账户续投基本操作 
 * @author ZJ   
 * @date 2018年1月22日 上午10:13:56 
 * @version V1.0   
 */
@Slf4j
@Service
public class AccountContinuedBaseService {
	@Autowired
